...
class Trie(object):
    ...
    # get the node that contains all the matches
...
output = autocomplete("bb")
print(output)


# words = orderResultsByLetter(["aaa", "bbb", "dog", "deer", "deal"])
# autocomplete("de", words)
