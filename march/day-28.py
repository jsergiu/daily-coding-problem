...
class XorLinkedList(object):
    ...
    def add(self, node):
        ...
        # Without this line, Python thinks there is no way to reach nodes
        # head and tail.
...
list = XorLinkedList()
XorLinkedList.add(list, 1)
XorLinkedList.add(list, 2)
XorLinkedList.add(list, 3)

print(XorLinkedList.get(list, 2))
